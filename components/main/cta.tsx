        ...
        <section id="contact" className="relative w-full py-40 bg-black overflow-hidden">
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <h2 className="text-5xl md:text-8xl font-bold text-white font-suit tracking-tight mb-10 leading-[1.2]">
                        비즈니스의 가치를 바꾸는<br />
                        웹사이트를 만듭니다.
                    </h2>
                    ...
                    >
                        <button className="px-12 py-6 rounded-full bg-white text-black text-[1.25rem] font-bold flex items-center gap-4 cursor-pointer transition-all hover:bg-[#f0f0f0] shadow-[0_20px_50px_rgba(255,255,255,0.1)] font-pretendard">
                            프로젝트 문의하기
